...
export default function ChipTestPage() {
  return (
    <main className="min-h-screen bg-surface-secondary p-10">
      ...
      {/* Large Size */}
      <section className="mb-12 rounded-xl border border-surface-tertiary bg-surface-primary p-6">
      ...
      {/* 모든 조합 비교 */}
      <section className="mb-12 rounded-xl border border-surface-tertiary bg-surface-primary p-6">
        <h2 className="mb-4 text-2xl-sb text-color-primary">모든 조합</h2>
        <div className="grid grid-cols-2 gap-8">
          {/* Large */}
          <div>
            <h3 className="mb-4 text-lg-sb text-color-primary">Large</h3>
          ...
          {/* Small */}
          <div>
            <h3 className="mb-4 text-lg-sb text-color-primary">Small</h3>
            <div className="space-y-3">
              <div className="flex items-center gap-4">
                <Chip state="default" size="small" count={3}>
                  법인 등기
      ...
      {/* 실제 사용 예시 */}
      <section className="mb-12 rounded-xl border border-surface-tertiary bg-surface-primary p-6">
        <h2 className="mb-4 text-2xl-sb text-color-primary">실제 사용 예시</h2>
        <div className="rounded-lg bg-surface-secondary p-6">
          <h3 className="mb-4 text-xl-sb text-color-primary">카테고리 필터</h3>
